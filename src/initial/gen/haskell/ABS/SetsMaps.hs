...
{-# LINE 15 "initial\SetsMaps.abs" #-}
data Set a = EmptySet
           | Insert !a !(Set a)
           deriving (I'.Eq, I'.Ord, I'.Show)

set :: forall a . _ => List a -> Set a
{-# LINE 21 "initial\SetsMaps.abs" #-}
set l
  = case l of
        [] -> EmptySet
...
{-# LINE 59 "initial\SetsMaps.abs" #-}
emptySet xs = (xs == EmptySet)

size :: forall a . _ => Set a -> Int
{-# LINE 69 "initial\SetsMaps.abs" #-}
size xs
  = case xs of
        EmptySet -> 0
